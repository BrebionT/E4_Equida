...
public class ServletCheval extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(url.equals("/E4_Equida_Thibault/ServletCheval/infoCheval"))
        {  
        ...
        if(url.equals("/E4_Equida_Thibault/ServletCheval/ajouterCheval"))
        {                   
        ...
        if(url.equals("/E4_Equida_Thibault/ServletCheval/modifierCheval"))
        {
