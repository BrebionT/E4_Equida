...
public class ServletVentes extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(url.equals("/E4_Equida_Thibault/ServletVentes/listerLesVentes"))
        {  
        ...
        if(url.equals("/E4_Equida_Thibault/ServletVentes/listerLesClients"))
        {  
        ...
        if(url.equals("/E4_Equida_Thibault/ServletVentes/listerLesCourriels"))
        {  
        ...
        if(url.equals("/E4_Equida_Thibault/ServletVentes/listerLesLots"))
        {  
