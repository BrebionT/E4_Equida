...
public class ServletAdmin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      this.getServletContext().getRequestDispatcher("/vues/Lieu/AjouterLieu.jsp" ).forward( request, response );
       ...
       if(url.equals("/E4_Equida_Thibault/ServletAdmin/listerLesPays"))
        {  
        ...
        if(url.equals("/E4_Equida_Thibault/ServletAdmin/listerLesLieux"))
       {
         ...
         if(url.equals("/E4_Equida_Thibault/ServletAdmin/lieuModifier")){
         ...
         if(url.equals("/E4_Equida_Thibault/ServletAdmin/supprimerLieu"))
        {
          String id = (String)request.getParameter("idLieu");
          Lieu unLieu = LieuDAO.getleLieu(connection,id);
          request.setAttribute("pLeLieu", unLieu);
         ...
         if(url.equals("/E4_Equida_Thibault/ServletAdmin/listerLesCategVente")){
         ...
         if(url.equals("/E4_Equida_Thibault/ServletAdmin/categVenteModifier")){
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         Lieu unLieu = form.AjouterLieu(request);
          ...
          else
          {
              ...
              request.setAttribute("pErreur", "Erreur ! Un des champs est vide ...");
