    ...
    <center>
        ...
        <form class="form-inline" action="supprimerLieu" method="POST">
            <center>
                ...
                <input class="form-control" style="margin-bottom:10px;" id="nbBoxes"  type="text"  name="nbBoxes" size="30" maxlength="30" value="<%out.println(leLieu.getNbBoxes());%>" readonly>      
                 </br>
                 
                  <label for="commentaire">COMMENTAIRE </label>
                <input class="form-control" style="margin-bottom:10px;" id="commentaire"  type="text"  name="commentaire" size="30" maxlength="30" value="<%out.println(leLieu.getCommentaires());%>" readonly>      
                 </br>
