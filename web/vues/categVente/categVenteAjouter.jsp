    ...
    <center>
        <form class="form-inline" action="ajouterCategVente" method="POST">
            <center>
                ...
                <input class="form-control" style="margin-bottom:10px;" id="code" type="text" name="code"  size="30" maxlength="5">
                </br>
                
                <label for="libelle">LIBELLE  </label>
                <input class="form-control" style="margin-bottom:10px;" id="libelle"  type="text"  name="libelle" size="30" maxlength="30">      
                 </br>
