        ...
        <table style="width:90%; margin:auto; margin-bottom:50px;" class="table ">  
            <thead class="thead-dark">
                <tr>             
                    ...
                    <th class="text-center">Prix de Depart</th>
                    <th class="text-center">Nom du cheval</th>
            ...
            <tbody>
                <tr>
                    ...
                    for(int i = 0; i < lesLots.size();i++)
                    {
                        ...
                        out.println("<td class='text-center'><a href ='../ServletCheval/infoCheval?idCheval="+ unLot.getUnCheval().getId()+ "'>");
